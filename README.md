...
* [Y] User can **search for images** by specifying a query and launching a search. Search displays a grid of image results from the Google Image API.
...
* [Y] User can configure advanced search filters such as:
  * [Y] Size (small, medium, large, extra-large)
  * [Y] Color filter (black, blue, brown, gray, green, etc...)
  * [Y] Type (faces, photo, clip art, line art)
  * [Y] Site (espn.com)
* [Y] Subsequent searches have any filters applied to the search results
* [Y] User can tap on any image in results to see the image **full-screen**
* [Y] User can **scroll down to see more images**. The maximum number of images is 64 (limited by API).
...
![Video Walkthrough](gridImagesSearch.gif)
